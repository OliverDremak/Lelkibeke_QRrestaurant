...
export const useAuthStore = defineStore('auth', {
    ...
    actions: {
      async login(email: string, password: string) {
          ...
          this.error = null
          try {
            const response = await $fetch<AuthResponse>('https://api.innerpeace.jedlik.cloud/api/login', {
              method: 'POST',
              body: { 
                email,
                password
      ...
      async register(name: string, email: string, password: string) {
        ...
        try {
          ...
          const response = await $fetch<AuthResponse>('https://api.innerpeace.jedlik.cloud/api/register', {
            method: 'POST',
